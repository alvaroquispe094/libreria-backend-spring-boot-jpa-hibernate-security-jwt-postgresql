//package com.groupal.shoppingLibraryBackend.security;
//
...
//
//import com.groupal.shoppingLibraryBackend.service.UsuarioService;
//
//
//@Configuration
//@EnableWebSecurity
...
//        		.authorizeRequests()
//                .antMatchers("/api/auth/registrar", "/static/**", "/**", "/index.html", "/**.css", "/**.js", "/**.ico", "/assets/images/**", "/**.woff", "/**.ttf", "/target/shoppingLibraryBackend-0.0.1-SNAPSHOT.jar", "/landing/**").permitAll()
